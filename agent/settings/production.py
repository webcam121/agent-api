...
ALLOWED_HOSTS = [
    'agent-prod-backend.us-east-2.elasticbeanstalk.com',
    'agent-frontend-prod.us-east-2.elasticbeanstalk.com',
    'app.agent.ai',
    'agent.ai',
    'agent-app-dev.us-east-2.elasticbeanstalk.com',
    'test.agent.ai',
]
...
CORS_ALLOWED_ORIGINS = [
    'http://agent-prod-backend.us-east-2.elasticbeanstalk.com',
    'https://app.agent.ai',
...
AWS_PUBLIC_STATIC_STORAGE_BUCKET_NAME = 'agent-public-assets-production'
