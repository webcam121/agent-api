...
INSTALLED_APPS = [
    ...
    'agent.apps.basic_questions.apps.BasicQuestionsConfig',
    'agent.apps.questions.apps.QuestionsConfig',
    'agent.apps.basic_answers.apps.BasicAnswersConfig',
    'agent.apps.call_sessions.apps.CallSessionsConfig',
    'agent.apps.call_schedules.apps.CallSchedulesConfig',
    'agent.apps.deliveries.apps.DeliveriesConfig',
    'agent.apps.notifications.apps.NotificationsConfig',
    'agent.apps.eta_tasks.apps.EtaTasksConfig',
]
