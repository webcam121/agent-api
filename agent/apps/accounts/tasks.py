...
from agent.apps.deliveries.utils import generate_invitation_email_to_user_from_receiver_content, \
    generate_invitation_email_to_non_user_from_receiver_content, generate_invitation_email_to_user_from_giver_content, \
